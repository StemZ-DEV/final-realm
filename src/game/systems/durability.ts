import type { ItemDefinition, ItemInstance, Player } from "../models.js";

export function degradeEquipment(player: Player): void {
...
export function repairCost(def: ItemDefinition, instance: ItemInstance): number {
...
export function repairItem(def: ItemDefinition, instance: ItemInstance): void {
