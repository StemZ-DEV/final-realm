...
const STAT_KEYS = ["strength", "defense", "agility", "intelligence", "wisdom", "vitality"] as const;

export class StatsScene implements Scene<GameContext> {
  private menu = new MenuModel(STAT_KEYS.map((key) => ({ label: key, value: key })));
